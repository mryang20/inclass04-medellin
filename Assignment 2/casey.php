	...
	<figure><img src="images/casey.jpg" class= "imgid" alt="casey"></figure>
		...
		<h2>About Me</h2>
			...
			<h3>Hobbies and Interests</h3>
				<p>In my free time, I like to sing, play guitar, and see as many movies as I can. On campus, I'm involved in TOOP, a student run theatrical group, and ROC Players, a musical theatre organization. In the past, I've appeared in plays in the Todd International Theatre Program. This semester, I'll be appearing onstage in ROC Player's production of Spring Awakening as Moritz Steifel.</p>
