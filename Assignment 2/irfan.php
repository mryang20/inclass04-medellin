	...
	<figure> <img src="images/irfan.jpg" class="imgid" alt="irfan"> </figure>
		...
		<h2>About Me</h2>
			...
			<h3>Hobbies and Interests</h3>
				<p>My hobbies are as basic as it gets. I like to read books (both fiction and non fiction), mostly books that deal with metaphysics, psychology, love, science, poetry and human nature, although I am not a picky reader and will read anything. Consequently, I like to write too. I mostly write short stories, news articles and poetry. I still don’t think I can write in English as well as I can write in Urdu. I like to read books that are written in English, but my language preference for poetry is Urdu. I think English is very well suited for prose but not poetry. I like to listen to Sufi music in my spare time. One practice I have is: I try to identify layers of music in a song and then figure out the beat. I would like to learn an instrument- maybe flute or violin.</p>
